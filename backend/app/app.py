...
from routers import auth, comments, dev_oauth, follows, movie_logs, movie_metadata, movie_metadata_batch, movies, notifications, reports, root, venues, public_profile
...
def create_app() -> FastAPI:
    ...
    app.include_router(movie_metadata_batch.router, prefix=f'{api_prefix}/movie-metadata')
